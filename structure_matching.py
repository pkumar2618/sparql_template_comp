...
questions=  qald_queries_df['sentence_en']
...
for query in queries:
    try:
        ...
        for template_triples_list in template_store_df["template_processed_triples"]:
            ...
            try:
                if isomorphic(q_graph.processed_graph, template_graph) or similar(q_graph.processed_graph, template_graph):
